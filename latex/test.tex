...
"Взгляните на мои товары?"\,, говорит Гинчи, "скидки новым покупателям"

\end{boxed}

give the players a list of things they can buy. Ghinci sells the potion of animal tongue for half the price. if the players leave without buying it, have him give it for free.

\begin{boxed}
"Эй, подождите, *протягивает зелье разговора с животными*, в знак новой дружбы"
\end{boxed}

\subsection{Tavern}
the tavern is full of people, all the usual stuff.

\begin{boxed}
На вывеске таверны название -- "Коготь Медведя". Изнутри доносятся разговоры и редкие раскаты смеха.

Как вы заходите внутрь, вы слышите голос

"Присаживайтесь, присаживайтесь мои хорошие!"

к вам направляется хозяин таверны, в руках у него метла, и он судя по всему только что подметал пол.
...
\begin{boxed}
  ...
  \textbf{per low} но есть странный привкус. Такой очень сладкий, но земельный, что ли. 
\end{boxed}

have players drink

\begin{boxed}
  вы чувствуете себя странно, голова слегка кружится, но это можно списать на эффекты алкоголя. пиво все-таки крепкое.

  \textbf{con imp}. ты вдруг понимаешь что не помнишь почему ты здесь, но выпивка хороша и тебе все равно. ты ничего никому не говоришь
\end{boxed}

if players ask the tavern keeper, have him bite his broom

\begin{boxed}
  ... Да обычная выпивка, я ей уже сколько лет торгую, и сам пью. постойте ... а сколько я ей торгую. 

  Оставьте меня, мне нужно побыть одному
\end{boxed}

\subsection{Brewery}
there's a black cat called Joseph. 
...
hopefully they'll talk to the cat

\begin{boxed}
  ... Для остальных это звучит как мяуканье. 

  Чувак, тут что-то неладное, я по ночам вижу как вокруг колодца ошиваются странные типы. А эти (показывает на людей) потом на этой воде выпивку варят.
\end{boxed}

\subsection{Well}
they should be hooked by now I HOPE

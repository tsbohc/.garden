...
\begin{boxed}
Во время совместных путешествий до вас донеслись слухи о небольшой деревне, которая недавно прославилась своим элем. Заинтригованные проспектами диковенной выпивки, вы в пути уже несколько дней. И вот, наконец, лесная чаща расступаются и вы выходите на дорогу через поле.
...
On the way there they meet a travelling merchant, a dark elf named Ginchi. He sparks the conversation. Ghinci used to be a mercenary, but his friend got killed on a job, and now he's a simple merchant. He's charismatic and friendly. Also after the booze.
...
Ну, увидимся в таверне. Подгоняет лошадь и уносится вперед.
\end{boxed}

\section{Act I: The Village}
A scene on the outskirts of the village with Ghinci. He leaves after.

\begin{boxed}
Подходя к деревне вы замечаете как Гинчи разговаривает с кем-то. Выражение лица у него слегка опешаное, а женщина с которой он говорит ведет себя довольно холодно.
\end{boxed}

Village description. Tavern, Brewery, Ghinci's cart.

\begin{boxed}
Картина перед вами скромная: несколько домов сложенных из бревен, а среди них только пивоварня и таверна. Близ таверны стоит повозка Гинчи, он сидит ступеньке хмурый и курит.
\end{boxed}

\subsection{Ghinci's Cart}
\begin{boxed}
Да так, ничего... старая знакомая.
\end{boxed}
...
\begin{boxed}
Улыбка возвращается на лицо Гинчи. "Скидки новым покупателям"
\end{boxed}

After that, he leaves to have a drink.

\begin{boxed}
Я пойду выпить, увидимся.
\end{boxed}
...
Помещение хорошо освещено, стены бревенчатые. несколько штук круглых столов, барная стойка. на стене голова медведя, на полу ковер. Как бы убрано, но не сказать чтобы очень чисто

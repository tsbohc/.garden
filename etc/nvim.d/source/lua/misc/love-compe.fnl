...
(fn Source.determine [self context]
  (compe.helper.determine context {:keyword_pattern "love."}))

; just a large table generated from source, v11.3 + 3 main fns at the top + concord aliased as ecs
; {{{
(local items
  ["love.load"
   "love.update"
   ...
   ;"ecs.entity.destroy"
   ;"ecs.entity.deserialize"
   ;"ecs.entity.serialize"
   ;"ecs.entity.getWorld"
   ;"ecs.entity.inWorld"
   ;"ecs.entity.getComponents"
   ;"ecs.entity.get"
   ;"ecs.entity.remove"
   ;"ecs.entity.ensure"
   ;"ecs.entity.has"
   ...
   ;"ecs.entity.give"
   ;"ecs.entity.assemble"
   ;"ecs.component.deserialize"
   ;"ecs.component.serialize"
   ;"ecs.component.getName"
   ;"ecs.component.hasName"
   ;"ecs.component.new"
   ;"ecs.system.onDisabled"
   ;"ecs.system.onEnabled"
   ;"ecs.system.getName"
   ;"ecs.system.init"
   ;"ecs.system.isEnabled"
   ;"ecs.system.getWorld"
   ;"ecs.system.setEnabled"
   ;"ecs.system.hasName"
   ;"ecs.system.new"
   ;"ecs.world.deserialize"
   ;"ecs.world.serialize"
   ;"ecs.world.getSystems"
   ;"ecs.world.getName"
   ;"ecs.world.getSystem"
   ;"ecs.world.emit"
   ;"ecs.world.addSystem"
   ...
   ;"ecs.world.getEntities"
   ;"ecs.world.onEntityRemoved"
   ;"ecs.world.onEntityAdded"
   ;"ecs.world.clear"
   ;"ecs.world.hasName"
   ;"ecs.world.hasSystem"
   ;"ecs.world.addEntity"
...
(compe.register_source :love Source)

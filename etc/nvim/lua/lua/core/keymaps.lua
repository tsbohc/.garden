...
do
  ...
  zest_keymap_0_ = {f = _0_, lhs = "e", modes = "nv", opts = {expr = true, noremap = true}, rhs = "v:lua._zest.keymap.REs8jDAn.f()"}
  _G._zest.keymap["REs8jDAn"] = zest_keymap_0_
...
do
  ...
  zest_keymap_0_ = {f = _0_, lhs = "n", modes = "nv", opts = {expr = true, noremap = true}, rhs = "v:lua._zest.keymap.NIHdN74g.f()"}
  _G._zest.keymap["NIHdN74g"] = zest_keymap_0_
  vim.api.nvim_set_keymap("n", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
  vim.api.nvim_set_keymap("v", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
end
do
...
do
  ...
  _G._zest.keymap["J9XhnG1k"] = zest_keymap_0_
  vim.api.nvim_set_keymap("n", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
  vim.api.nvim_set_keymap("v", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
end
do
  ...
  zest_keymap_0_ = {f = _0_, lhs = "*", modes = "n", opts = {noremap = true}, rhs = ":call v:lua._zest.keymap.t7hNs6oe.f()<cr>"}
  _G._zest.keymap["t7hNs6oe"] = zest_keymap_0_
  vim.api.nvim_set_keymap("n", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
end
do
  local zest_keymap_0_
  ...
  zest_keymap_0_ = {f = _0_, lhs = "*", modes = "x", opts = {noremap = true}, rhs = ":call v:lua._zest.keymap.zHtC3NIi.f()<cr>"}
  _G._zest.keymap["zHtC3NIi"] = zest_keymap_0_
...
do
  ...
  _G._zest.keymap["DUZk558l"] = zest_keymap_0_
  vim.api.nvim_set_keymap("n", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
end
do
  local zest_keymap_0_ = {lhs = "<leader>r", modes = "x", opts = {noremap = true}, rhs = ":s///g<left><left>"}
  _G._zest.keymap["oSGeiDyX"] = zest_keymap_0_
  vim.api.nvim_set_keymap("x", zest_keymap_0_.lhs, zest_keymap_0_.rhs, zest_keymap_0_.opts)
end
do
  local zest_opts_0_ = {noremap = true}

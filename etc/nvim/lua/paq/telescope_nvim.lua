...
ki.n('<leader>tq', function() t('quickfix', {
   trim_text = true
}) end, { 'silent' })
ki.n('<leader>tg', function() t('live_grep') end, { 'silent' })
ki.n('<leader>tt', function() t('find_files', { cwd = '~' }) end, { 'silent' })
ki.n('<leader>tv', function() t('find_files', { cwd = '~/.garden/etc/nvim/' }) end, { 'silent' })

-- TODO: just a simple ripgrep thing
-- ki.n('<leader>tc', function()
